        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="deliveryManagements"
                        to="/deliveries/deliveryManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        ...
                        to="/inventories/inventoryManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'deliveryManagements', 
                route: '/deliveries/deliveryManagements',
                ImageUrl: '',
            },
            { 
                ...
                description: '', 
                key: 'inventoryManagements', 
                route: '/inventories/inventoryManagements',
                ImageUrl: '',
            },
